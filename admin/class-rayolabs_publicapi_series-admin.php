 ...
 * @subpackage Rayolabs_publicapi_series/admin
 */
 ...
 */
class Rayolabs_publicapi_series_Admin {
	...
	public function __construct( $plugin_name, $version,$api_url ) {
		...
		$this->rayolabs_publicapi_series = get_option($this->plugin_name);
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/rayolabs_publicapi_series-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/rayolabs_publicapi_series-admin.js', array( 'jquery' ), $this->version, false );
...
public function add_plugin_admin_menu() {
     ...
     *
     */
    add_options_page( 'Rayolabs Public Api Series Content King Base Options Functions Setup', 'RayoLabs PublicApi Series Content King', 'manage_options', $this->plugin_name, array($this, 'display_plugin_setup_page')
    );
}
...
public function display_plugin_setup_page() {
    include_once( 'partials/rayolabs_publicapi_series-admin-display.php' );
}
...
public function validate($input) {
    ...
    public function verify($token){
	  ...
	  $api = "$this->api_url/$token/o2tvseries";
